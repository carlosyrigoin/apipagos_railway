...
from .views import ServicesView, Services_createView, Services_detailView, Payment_userView, Payment_user_detailView, Expired_paymentsView, Expired_payments_detailView

services_router = DefaultRouter()
services_router.register(r"services", ServicesView, basename="services_view")
services_router.register(r"services_create", Services_createView, basename="services_create")
services_router.register(r"services_detail", Services_detailView, basename="services_detail")
